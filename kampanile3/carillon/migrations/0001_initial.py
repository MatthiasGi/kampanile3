# Generated by Django 5.2.5 on 2025-08-30 18:14
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('default', models.BooleanField(default=False, help_text='Whether this carillon is the default carillon. Only one carillon can be the default. If activated here, another carillon that was the default will loose that status.', verbose_name='Default')),
                ('active', models.BooleanField(default=True, help_text='Whether this carillon is active and can be used. May be deactivated to mute all songs.', verbose_name='Active')),
            ],
            options={
